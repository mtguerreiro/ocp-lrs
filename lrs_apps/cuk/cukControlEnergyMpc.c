...
int32_t cukControlEnergyMpcRun(void *meas, int32_t nmeas, void *refs, int32_t nrefs, void *outputs, int32_t nmaxoutputs){
    ...
    dv_min_z2 = (params.il_min * hwm->vi_dc - p_out - 2.0f * y_dot_comp + y_dot_comp_1) / (params.alpha * params.dt);
    dv_max_z2 = (params.il_max * hwm->vi_dc - p_out - 2.0f * y_dot_comp + y_dot_comp_1) / (params.alpha * params.dt);
