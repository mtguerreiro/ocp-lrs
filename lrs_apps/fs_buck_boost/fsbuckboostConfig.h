...
#define FS_BUCK_BOOST_CONFIG_I_LIM      10.0f
#define FS_BUCK_BOOST_CONFIG_V_LIM      30.0f
...
#define FS_BUCK_BOOST_CONFIG_TRACE_SIZE_BYTES       ((uint32_t)ZYNQ_CONFIG_MEM_TRACE_SIZE_MAX)
#else
#define FS_BUCK_BOOST_CONFIG_TRACE_SIZE_BYTES       (16U * 1024U * 1024U)
#endif
//=============================================================================
