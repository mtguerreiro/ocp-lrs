/*
 * C-Script file for: Outer loop/C-Script
 * Generated with   : PLECS 5.0.3
 * Generated on     : 3 Sep 2026 19:09:44
 */
...
void Plecs_controller_outer_loop_0_cScriptStart(
                                                const struct CScriptStruct *cScriptStruct)
{
}

void Plecs_controller_outer_loop_0_cScriptOutput(
                                                 const struct CScriptStruct *cScriptStruct)
{
}

void Plecs_controller_outer_loop_0_cScriptUpdate(
                                                 const struct CScriptStruct *cScriptStruct)
{
}

void Plecs_controller_outer_loop_0_cScriptDerivative(
                                                     const struct CScriptStruct *cScriptStruct)
{
}

void Plecs_controller_outer_loop_0_cScriptTerminate(
                                                    const struct CScriptStruct *cScriptStruct)
{
}
