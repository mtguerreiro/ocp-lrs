...
#define IPC_SERVER_ZYNQ_INT_CPU0_TO_CPU1_PRIO   ZYNQ_CONFIG_SIG_CPU0_TO_CPU1_PRIO
...
void ipcServerZynqInitialize(void *irqInst){
    ...
    XScuGic_SetPriorityTriggerType(
        xipcServerZynqControl.intcInstance,
        IPC_SERVER_ZYNQ_INT_CPU0_TO_CPU1, IPC_SERVER_ZYNQ_INT_CPU0_TO_CPU1_PRIO,
        0x3
    );

    XScuGic_Connect(
        xipcServerZynqControl.intcInstance, IPC_SERVER_ZYNQ_INT_CPU0_TO_CPU1,
